...
lambda = 1
beta.ENLS = ENLS(Xc, Yc, alpha, lambda, beta=matrix(0, ncol(Xc), 1), tol=1e-9)
...
beta.ENLS2 = ENLS(Xtilde, Ytilde, alpha=1, lambda=lambda*alpha, beta=matrix(0, ncol(Xc), 1), tol=1e-9)
